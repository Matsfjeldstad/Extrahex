...
export default function EcosystemSection({}: Props) {
  return (
    <section className='relative mt-20 flex h-full min-h-[80vh] w-full flex-col items-center justify-center gap-4 overflow-hidden text-white'>
      ...
      <div className='relative my-24 flex flex-col items-center justify-center gap-5 p-4 text-center'>
        <h2 className='text-3xl font-bold md:text-5xl'>Expaning the Ecosystem</h2>
        <p className='max-w-[700px] text-lg text-gray-300 [text-wrap:balance] md:text-2xl'>
          Many projects are buildt around Hex, opening more doors to use Hex
        </p>
        <Link className='text-2xl underline' href={'/ecosystem'}>
