...
export default function Home() {
  return (
    <motion.section
      className="font-argentum text-white overflow-hidden pattern-dots pattern-gray-900 pattern-bg-black
    ...
    >
      <motion.div
        ...
        animate="animate"
        initial="initial"
        className="flex flex-col p-3  gap-6 justify-center items-center h-screen w-screen"
      >
        <motion.div variants={item} className="flex items-center">
          <svg width="37" height="32" viewBox="0 0 37 32" className="fill-gray-200" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.h1 variants={item} className=" text-3xl md:text-5xl uppercase font-bold text-center">
          A New Hex Staking Interface
        </motion.h1>
        <motion.h2 variants={item} className="text-gray-300 text-lg">
          Coming Soon
        </motion.h2>
      </motion.div>
    </motion.section>
